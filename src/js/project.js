...
//       .from("activity")
//       .select("*")
//       .eq("activity_id", activity[0]?.activity_id);
...
//             <p class="project-description">${activity.activity_description}<br /></p>
...
//               ></i>
//               <span>Due: ${activity.activity_duedate}</span>
//             </div>
...
//   } else {
//     activitiesContainer.innerHTML = `<h2 class="empty" >No Projects yet for that course</h2  >`;
//   }
// }
...
//   console.log(e.target.dataset.btnFile);
...
//   const filePath = `https://iuiwdjtmdeempcqxeuhf.supabase.co/storage/v1/object/public/students-activities/${fileName}`;
//   const activityFile = fileInput.files[0];
//   const activityID = await getActivityID();

//   console.log(activityFile);
//   const { data, updateError } = await supaClient
//     .from("student_activity")
//     .update({ activity_path: filePath })
//     .eq("activity_id", activityID)
//     .eq("student_id", sessionStorage.getItem("studentId"))
//     .select();
//   console.log(data, updateError);

//   console.log(activityFile, fileName);
//   if (fileName && activityFile && !updateError) {
...
//       console.log(document.querySelector(".submit-btn").disabled);
//     }
//   }
// }
...
//       uploadedActivity && uploadedActivity.submission_date
//         ? formatDate(uploadedActivity.submission_date)
//         : "";
...
//         <h3 class="project-title">${activity.activity_title}</h3>
//         <p class="project-description">${activity.activity_description}</p>
//         <hr class="project-divider" />
...
//           }
//         </div>
//         <button class="instructions-btn" data-activity-id="${
...
//                <span>Due date has passed but you can still submit your project (late submission)</span>
//              </div>`
//               : ""
//           }
...
//       activity.activity_id
//     }">
//             ${dueDatePassed ? "Submit Late Project" : "Submit Project"}
//           </button>
//         </div>
//       </div>`;
//   });
    ...
    markup += `<div class="project-box ${dueDatePassed ? "" : "active"}">
      ...
      isUploaded || dueDatePassed ? "none" : "block"
          ...
          >
            ...
            <div class="text">
              <span>Click to upload project</span>
            </div>
            <input class="file__input" type="file" id="file-${index}" data-file="${index}" data-activity-id="${
      activity.activity_id
    }" />
